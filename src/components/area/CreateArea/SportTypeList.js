...
class SportTypeList extends React.Component {
    state = {
        single: null,
        multi: null,
    };
    ...
    handleChange = (selectedOption) => {
        var sporttypes = selectedOption.map((item) => ({id: item.value}))
        this.props.chooseAreaSportTypes(sporttypes);
      };
...
export default withStyles(styles)(SportTypeList);